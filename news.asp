	...
	<tr>
		...
		<table id="__01" width="716" height="667" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<div style="padding-top:11px; margin-left:25px; font-size:14px; font-weight:bold;color:#fff;">新闻中心</div>
				</td>
			</tr>
			<tr>
				...
				<div id="neiye_main">
								<!--内容开始 -->
										...
										［新闻动态］　  <a href="news_in.asp?categoryid=<%=rsn("categoryID")%>&amp;itemid=<%=rsn("id")%>" class="y_0"><%=rsn("title")%></a> </td>
										</tr>
										<tr>
