...
<table id="__01" width="961" height="1157" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<table id="__01" width="716" height="667" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td background="images/sss.jpg" width="716" height="32">
				<div style="padding-top:11px; margin-left:25px; font-size:14px; font-weight:bold;color:#fff;">代理记账</div>
				</td>
			</tr>
			<tr>
				...
				<div id="neiye_main">
								<!--内容开始 -->
											  <%
												...
												'''''模型表名称
												Dim ModelTable:ModelTable ="user_dljz"
											...
											%>
											  <%
														...
														set rs = UICon.Query("select * from user_dljz where ID="&ItemID&"")
														UIcon.execute("update user_dljz set Hots=Hots +1 where id="&ItemID&"")
											  ...
											  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													  ...
													  <table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
														  <td height="35" align="left" valign="middle" class="news_fabutime" style="font-weight: bold">发布时间：<%=rs("posttime")%></td>
															...
															上一篇文章：
																<%
													set rsu = Uicon.query("select top 1 id,categoryid,title from user_dljz where categoryid="&categoryid&" and id<"&itemid&" order by id desc")
												...
												<tr>
												  <td height="26">下一篇文章：
													<%
													set rsn = Uicon.query("select top 1 id,categoryid,title from user_dljz where categoryid="&categoryid&" and id>"&itemid&" order by id asc")
